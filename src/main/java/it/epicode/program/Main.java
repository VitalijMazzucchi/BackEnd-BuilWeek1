...
import it.epicode.biglietti.Periodicita;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		us3.setTessera(tes3);
		us4.setTessera(tes4);
		// modifico utente e ottengo in db la tabella con i campi delle tessere relativi
		// all'utente piene
		g.user.modifica(us1);
		g.user.modifica(us2);
		g.user.modifica(us3);
		...
		Tratta tra = new Tratta("Tratta del mausoleo", LocalTime.of(12, 20), LocalTime.of(14, 20),
				Duration.ofMinutes(45));
		Tratta tra1 = new Tratta("Tratta del Colosseo", LocalTime.of(17, 40), LocalTime.of(18, 20),
				Duration.ofMinutes(30));
		Tratta tra2 = new Tratta("Tratta del Testicolo", LocalTime.of(20, 0), LocalTime.of(21, 0),
				Duration.ofMinutes(5));
		g.tratta.save(tra);
		g.tratta.save(tra1);
		g.tratta.save(tra2);

		Abbonamento abb = new Abbonamento(112, LocalDate.of(2022, 8, 10), Periodicita.SETTIMANALE);
		Abbonamento abb1 = new Abbonamento(130, LocalDate.of(2020, 9, 1), Periodicita.MENSILE);
		Abbonamento abb2 = new Abbonamento(118, LocalDate.of(2021, 12, 30), Periodicita.ANNUALE);
		g.ticket.save(abb);
		g.ticket.save(abb1);
		g.ticket.save(abb2);

		Biglietto bi = new Biglietto(111, LocalDate.of(2022, 8, 1));
		Biglietto bi1 = new Biglietto(222, LocalDate.of(2020, 10, 21));
		Biglietto bi2= new Biglietto(333, LocalDate.of(2021, 11, 15));
		Biglietto bi3 = new Biglietto(444, LocalDate.of(1999, 9, 9));
		g.ticket.save(bi);
		g.ticket.save(bi1);
		g.ticket.save(bi2);
		g.ticket.save(bi3);
